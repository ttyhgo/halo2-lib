...
impl<F: PrimeField, FC: FieldChip<F>> EccChip<F, FC> {
        ...
        C::Base: ff::PrimeField,
    {
        ...
        rhs = self.field_chip.add_constant_no_carry(ctx, &rhs, FC::fe_to_constant(C::a()));
